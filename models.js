 ...
 * @param {string} password - receives user's typed password 
 * @returns @password string, returns hashedPassword
 */
...
/**
 * This function compares and validates the user's password
